...
import {WebSocketServer as $72vZL$WebSocketServer, WebSocket as $72vZL$WebSocket} from "ws";
import $72vZL$depictaiutilishared from "@depict-ai/utilishared";
...
function $bff1ad446ee77bcc$export$b577aa09e26bbdeb(gpio) {
    // @ts-ignore
...
async function $f49e5f5ee91f044f$var$main() {
    ...
    (0, $72vZL$runWithOwner)(owner, ()=>(0, $bff1ad446ee77bcc$export$b577aa09e26bbdeb)(gpio));
}
